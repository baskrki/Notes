...
Notice that,
\begin{align*}
    |a_n-a_{n+1}| &\le c|a_{n-1}-a_{n}| \\
    &\le c^2 |a_{n-2}-a_{n-1}| \\
...
\begin{align*}
    ...
    &\le |a_1-a_2| + \sum_{i=2}^{m-1} c^{i} |a_1-a_2| \\
    &\le |a_1-a_2| \left( \sum_{i=1}^{m-1} c^i \right) \\
    &\le |a_1-a_2| \left(\frac{1-c^{m}}{1-c}\right) \le \left(\frac{1}{1-c}\right)|a_1-a_2|
\end{align*}
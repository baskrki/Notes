...
Now, we construct a new basis which is 
\[ 
\left( \frac{v_1}{{}_{1}\lambda_{1}} , \frac{v_2}{{}_{2}\lambda_{1}} - \frac{v_1}{{}_{1}\lambda_{1}}, \cdots, \frac{v_m}{{}_{m}\lambda_{1}} 
- \frac{v_{m-1}}{{}_{m-1}\lambda_{1} } \right) 
\]

If ${}_{k} \lambda_1=0$ then we just replace ${}_{k} \lambda_1=1$. One can check that, this is a basis of $V$ and 
\begin{align*}
    T\left(\frac{v_k}{{}_{k}\lambda_{1}} - \frac{v_{k-1}}{{}_{k-1}\lambda_{1}}\right) &= 
    \frac{1}{{}_{k}\lambda_1}T(v_k)-\frac{1}{{}_{k-1}\lambda_1}T(v_{k-1}) \\

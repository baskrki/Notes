...
\begin{proof}
    ...
    for all $v \in V$. We know that $q(T)v \neq 0$ for some $v \in V$ because its not the minimal polynomial and $q(T)v=k$, 
...
\begin{proof}
    ...
    Thus $r \equiv 0$ as if not then would violet $p$ being the minimal polynomial. Thus, $q=ps$.
\end{proof}
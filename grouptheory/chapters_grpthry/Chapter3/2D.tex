...
\begin{theorem}[Jordan-H\"older] Let $G$ be a finite group with $G \neq 1$. Then, 
    \begin{enumerate}
        \item $G$ has a composition series and
        \item The composition factors in a composition series are unique, namely if \newline $1 = N_0 \le \cdots \le N_r = G$ and 
              $1 = M_0 \le \cdots \le M_s = G$ are composition series for $G$ then $r=s$ and there is some permutation, $\pi$, of 
              $\{1,2\ldots,r\}$ such that
              \[ M_{\pi(i)}/M_{\pi(i)-1} \cong N_i/N_{i+1}, \quad i \le i \le r \]
    \end{enumerate}
\end{theorem}
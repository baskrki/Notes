...
\begin{proof}
    ...
    $N \unlhd G$. Now, suppose $N \unlhd G$ then we define a map $\psi : G \to G/N$ such that $g \mapsto gN$.
    Then,
    \begin{align*}
...
\begin{definition}
    Let $N \unlhd G$. The homomorphism $\psi : G \to G/N$ defined by $\psi(g)=gN$ is called the \textit{natural projection} of $G$ onto
